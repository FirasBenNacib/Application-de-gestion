...
#include "interface.h"
#include "support.h"
#include "nourfonction.h"
//#include "nourfonction.c"
#include <stdlib.h>
#include <string.h>
...
void
on_MN_ajouteracc_clicked                   (GtkWidget       *button,
                                        gpointer         user_data)
{
GtkWidget* input;
GtkWidget* output;
...
///////////////////////// Tache modification ///////////////////////////////////////////
void
on_MN_modifieracc_clicked                  (GtkWidget       *button,
                                        gpointer         user_data)
{
int MN_index=0;
char text[100];
...
void
on_MN_supprimeracc_clicked                 (GtkWidget       *button,
                                        gpointer         user_data)
{
char text[100];
GtkWidget *outputMsg;
...
on_MN_login_clicked                    (GtkButton       *button,
                                        gpointer         user_data)
{
GtkWidget *username, *password, *outputMsg;
char user[20];
char passw[20];
char text[50];
int trouve;
...
if  ( (strcmp(user,"houssem")==0) && (strcmp(passw,"houssem")==0) ){
GtkWidget *foyer;
foyer = create_hkwindowgestion();
...
{
    strcpy (text,"Veuillez verifier les informations saisies");
...
if  ( (strcmp(user,"hamza")==0) && (strcmp(passw,"hamza")==0) ){
GtkWidget* MNauthentification;
...
if  ( (strcmp(user,"nada")==0) && (strcmp(passw,"nada")==0) ){
GtkWidget* input;
GtkWidget* output;
GtkWidget* MNauthentification;
GtkWidget *treeview1;
...
if  ( (strcmp(user,"nour")==0) && (strcmp(passw,"nour")==0) ){
/*GtkWidget *admin;
admin = create_MNaccueil();
...
if  ( (strcmp(user,"raya")==0) || (strcmp(passw,"raya")==0) ){
GtkWidget* input;
GtkWidget* output;
GtkWidget* MNauthentification;
...
if  ( (strcmp(user,"firas")==0) || (strcmp(passw,"firas")==0) ){
GtkWidget* input;
GtkWidget* output;
GtkWidget* MNauthentification;
...
strcpy(u.username ,gtk_entry_get_text ( GTK_ENTRY(username)));
strcpy(u.password ,gtk_entry_get_text ( GTK_ENTRY(password)));
MNtrouve=verif_authen(u.username,u.password);
MNcompare[20]=MN_authenrole(u.username,u.password);
...
//////////////////////////////////////////
if (strcmp(MNcompare,"Administrateur")==0)
{
GtkWidget *MNauthentification;
GtkWidget* MNaccueil;
GtkWidget* MNtreeview1;
...
dashboard_window_int=create_dashboard_window_int();
gtk_widget_show(dashboard_window_int);

/////////////////////////////////

GtkWidget *hamza_tree;
GtkWidget *nour_tree;
GtkWidget *nada_tree;
GtkWidget *firas_tree;

hamza_tree=lookup_widget(dashboard_window_int,"hamza_tree");

rupture(hamza_tree);
remove(hamza_tree);
//////////////////////////

firas_tree=lookup_widget(dashboard_window_int,"firas_tree");

dechets_menu(firas_tree);
remove(firas_tree);

///////////////////////////////////////////

nour_tree=lookup_widget(dashboard_window_int,"nour_tree");
etage_debit(nour_tree);
//afficher_etage(MNtreeview3);
remove(nour_tree);
//////////////////////////////////////////

//GtkWidget *entry_temperature;
GtkWidget *nada_hors_message;
int temperature,exists;

nada_tree = lookup_widget(dashboard_window_int,"nada_tree");
//entry_temperature = lookup_widget(window1_gestion,"entry_temperature");
nada_hors_message = lookup_widget(dashboard_window_int,"nada_hors_message");
//temperature = atoi(gtk_entry_get_text(GTK_ENTRY(entry_temperature)));
exists = capteurdef(nada_tree, temperature);
if(exists==0){
gtk_widget_show(nada_hors_message);
///////////////////////////////////////

nada_tree=lookup_widget(dashboard_window_int,"nada_tree");

capteurdef(nada_tree,temperature); }
remove(nada_tree);
