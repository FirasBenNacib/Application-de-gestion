...
int verif_authen(char *log[], char *pw[])
{
int trouve=-1;
users u;
FILE *f=NULL;
...
{if( (strcmp(u.username,log)==0) && (strcmp(u.password,pw)==0)){
trouve=1;}
}
}
fclose(f);
...
//////////////////////// verifier le role  dans authentification /////////////////////////////////

char MN_authenrole(char *log[], char *pw[])
{
char retour[20];
//int MNtest1;
users u;
